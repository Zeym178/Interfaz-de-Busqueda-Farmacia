...
if(isset($_POST['input'])){
    ...
    if (!empty($input)) {
        ...
        ORDER BY (CASE 
                  ...
                  ELSE 3
                END), relevance DESC LIMIT $results_per_page OFFSET $offset";
    } else {
        $query = "SELECT * FROM productos LIMIT $results_per_page OFFSET $offset";
    }
    

    //$query = "SELECT * FROM productos WHERE nom_pro LIKE '%{$input}%' LIMIT $results_per_page OFFSET $offset";
